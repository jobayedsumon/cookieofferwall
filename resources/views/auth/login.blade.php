                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-icon mb-3">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="Enter email..." required autofocus tabindex="100">
                        </div>
                        @enderror
                    </div>
                    <div class="mb-2">
                        @error('password')
                        <label class="form-label text-red font-weight-bold">{{ $message }}<span class="form-label-description text-blue font-weight-normal"><a href="./forgot-password.html" tabindex="104">I forgot password</a></span></label>
                        <div class="input-icon mb-3">
                            <span class="input-icon-addon">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z"></path>
                            ...
                            <div class="input-group input-group-flat"><input type="password" name="password" class="form-control is-invalid" placeholder="password" required autocomplete="current-password" tabindex="101"></div>
                        </div>
                        @else
                        <label class="form-label">Password @if (Route::has('forget')) <span class="form-label-description"><a href="{{ route('forget') }}" tabindex="104">I forgot password</a></span> @endif </label>
                        <div class="input-icon mb-3">
                            <span class="input-icon-addon">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z"></path>
                            ...
                            <input type="password" name="password" class="form-control" placeholder="password" required tabindex="101">
                        </div>
                        @enderror
                    </div>
                    <div class="mb-2">
