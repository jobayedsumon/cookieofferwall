...
<div class="row mt-4">
    <div class="col-lg-3 col-md-4 col-sm-6 pb-4">
        <form id="imgForm" class="bg-gray-lt card fixed-height d-flex justify-content-center text-center" method="post" action="{{route('game_jpz_add')}}" enctype="multipart/form-data">
            @csrf
    ...
    @foreach($data['q'] as $d)
    <div class="col-lg-3 col-md-4 col-sm-6 pb-4">
        <a href="#" class="btn-edit card d-block text-center" data-id="{{$d->id}}" data-toggle="modal" data-target="#jpz-edit" data-backdrop="static" data-keyboard="false">
...
<div class="modal modal-blur fade" id="jpz-edit" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content card">
            ...
            <div class="card-body pt-3">
                <form method="post" action="{{route('game_jpz_edit')}}" enctype="multipart/form-data">
                    @csrf
                ...
                <form method="post" action="{{route('game_jpz_del')}}">
                    @csrf
