...
<div class="row">
    <div class="col-lg-4 col-md-5 col-sm-12">
        <form class="card px-0" method="post" action="{{route('game_jpz_category_add')}}">
            @csrf
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="jpz_category_name" placeholder="Basic Puzzle" value="{{old('jpz_category_name')}}">
                </div>
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="mb-3">
                            <label class="form-label">Columns:</label>
                            <input type="text" class="form-control" name="jpz_category_col" placeholder="4" value="{{old('jpz_category_col')}}">
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div class="mb-3">
                            <label class="form-label">Rows:</label>
                            <input type="text" class="form-control" name="jpz_category_row" placeholder="3" value="{{old('jpz_category_row')}}">
                        </div>
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="jpz_category_time" placeholder="30" value="{{old('jpz_category_time')}}">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="jpz_category_cost" placeholder="100" value="{{old('jpz_category_cost')}}">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="jpz_category_reward" placeholder="500" value="{{old('jpz_category_reward')}}">
                            <span class="input-group-text">{{strtolower(env('CURRENCY_NAME'))}}s</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="card fixed-img-height d-flex justify-content-center">
                    <a href="{{route('game_jpz', ['id' => $c->id])}}" class="d-block text-center">
...
<form method="post" action="{{route('game_jpz_category_del')}}" class="modal modal-blur fade" id="cat-del" tabindex="-1" role="dialog" aria-hidden="true">
    @csrf
...
<form method="post" action="{{route('game_jpz_category_edit')}}" class="modal modal-blur fade" id="cat-edit" tabindex="-1" role="dialog" aria-hidden="true" enctype="multipart/form-data">
    @csrf
...
<form method="post" action="{{route('game_jpz_settings_update')}}" class="modal modal-blur fade" id="cat-update" tabindex="-1" role="dialog" aria-hidden="true">
    @csrf
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content card">
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="time" value="{{env('JPZ_TIME_OFFSET')}}">
                        <span class="input-group-text">seconds</span>
                    </div>
                </div>
                <div class="mb-3">
                    <label class="form-label">Maximum round per day:</label>
                    <input type="text" class="form-control" name="round" value="{{env('JPZ_MAX_ROUND')}}">
                </div>
                <div class="mb-3">
                    <label class="form-label">Help cost:</label>
                    <input type="text" class="form-control" name="piece" value="{{env('JPZ_PIECE_COST')}}">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary mr-auto" data-dismiss="modal">Cancel</button>
