            ...
            <div class="card-body">
                <label class="form-selectgroup-item flex-fill">
                    ...
                    <div class="form-selectgroup-label d-flex align-items-center pl-3 pr-3 pt-1 pb-1 mb-1">
                        ...
                        <div class="form-selectgroup-label-content d-flex align-items-center">
                            <span class="avatar rounded mr-3" style="background-image: url(/img/single_account.png)"></span>
                            <div class="lh-sm">
                ...
                <label class="form-selectgroup-item flex-fill">
                    ...
                    <div class="form-selectgroup-label d-flex align-items-center pl-3 pr-3 pt-1 pb-1 p-3 mb-1">
                        ...
                        <div class="form-selectgroup-label-content d-flex align-items-center">
                            <span class="avatar rounded mr-3" style="background-image: url(/img/block_vpn.png)"></span>
                            <div class="lh-sm">
                ...
                <label class="form-selectgroup-item flex-fill">
                    ...
                    <div class="form-selectgroup-label d-flex align-items-center pl-3 pr-3 pt-1 pb-1 p-3 mb-1">
                        ...
                        <div class="form-selectgroup-label-content d-flex align-items-center">
                            <span class="avatar rounded mr-3" style="background-image: url(/img/monitor_vpn.png)"></span>
                            <div class="lh-sm">
                ...
                <label class="form-selectgroup-item flex-fill">
                    ...
                    <div class="form-selectgroup-label d-flex align-items-center pl-3 pr-3 pt-1 pb-1 p-3 mb-1">
                        ...
                        <div class="form-selectgroup-label-content d-flex align-items-center">
                            <span class="avatar rounded mr-3" style="background-image: url(/img/block_rooted.png)"></span>
                            <div class="lh-sm">
                ...
                <label class="form-selectgroup-item flex-fill">
                    ...
                    <div class="form-selectgroup-label d-flex align-items-center pl-3 pr-3 pt-1 pb-1 p-3 mb-1">
                        ...
                        <div class="form-selectgroup-label-content d-flex align-items-center">
                            <span class="avatar rounded mr-3" style="background-image: url(/img/auto_ban_multi.png)"></span>
                            <div class="lh-sm">
                ...
                <label class="form-selectgroup-item flex-fill">
                    ...
                    <div class="form-selectgroup-label d-flex align-items-center pl-3 pr-3 pt-1 pb-1 p-3 mb-1">
                        ...
                        <div class="form-selectgroup-label-content d-flex align-items-center">
                            <span class="avatar rounded mr-3" style="background-image: url(/img/auto_ban_vpn.png)"></span>
                            <div class="lh-sm">
                ...
                <label class="form-selectgroup-item flex-fill">
                    ...
                    <div class="form-selectgroup-label d-flex align-items-center pl-3 pr-3 pt-1 pb-1 p-3 mb-1">
                        ...
                        <div class="form-selectgroup-label-content d-flex align-items-center">
                            <span class="avatar rounded mr-3" style="background-image: url(/img/auto_ban_rooted.png)"></span>
                            <div class="lh-sm">
                ...
                <label class="form-selectgroup-item flex-fill">
                    ...
                    <div class="form-selectgroup-label d-flex align-items-center pl-3 pr-3 pt-1 pb-1 p-3 mb-1">
                        ...
                        <div class="form-selectgroup-label-content d-flex align-items-center">
                            <span class="avatar rounded mr-3" style="background-image: url(/img/cc_change.png)"></span>
                            <div class="lh-sm">
