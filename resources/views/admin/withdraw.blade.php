    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <h5 class="my-0">{{env('CURRENCY_NAME')}}s in exchange: <span class="text-muted">{{$w->points}}</span></h5>
                <h4 class="mt-2 mb-4">Send to: <span class="text-azure">{{$w->to_acc}}</span></h4>
                <div class="card-text d-flex">
                    <a href="{{route('withdraw_proceed', ['id' => $w->id])}}" class="btn btn-primary">Mark proceed</a>
                    <a id="checker" data-wid="{{$w->id}}" class="btn btn-white ml-auto">Fraud check</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <table class="table table-vcenter card-table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-dark"><a href="{{route('userinfo', ['userid' => $c->userid])}}" class="text-reset">{{$c->userid}}</a></td>
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div id="mdc" class="modal-footer">
                <button type="button" class="btn btn-secondary btn-block" data-dismiss="modal">Close this window</button>
            </div>
        </div>
    </div>
</div>
