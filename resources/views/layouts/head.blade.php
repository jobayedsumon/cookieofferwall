...
<head>
    ...
    <link href="/css/tablerd.min.css" rel="stylesheet" />
    @yield('css')
</head>
                ...
                <div class="navbar-nav flex-row order-md-last">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-toggle="dropdown">
                            <span class="avatar" style="background-image: url({{$admin_share['avatar'] == null ? '/img/admin.png' : $admin_share['avatar']}})"></span>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <li><a class="dropdown-item font-weight-bold" href="{{route('support')}}">User Support</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#navbar-base" data-toggle="dropdown" role="button" aria-expanded="false">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <li><a class="dropdown-item" href="{{route('networks_custom')}}">Custom Offerwall</a></li>
                                    <li><a class="dropdown-item" href="{{route('networks_youtube')}}">YouTube Videos</a></li>
                                    <li><a class="dropdown-item text-muted" href="{{route('networks_ppv')}}">Pay Per View &nbsp; <small>(disabled)</small></a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#navbar-base" data-toggle="dropdown" role="button" aria-expanded="false">
                                ...
                                <ul class="dropdown-menu">
{{--                                    <li><a class="dropdown-item font-weight-bold" href="{{route('game_tour')}}">Quiz Tournament</a></li>--}}
{{--                                    <div class="dropdown-divider"></div>--}}
...
{{--                                    <li><a class="dropdown-item" href="{{route('game_jpz_category')}}">Jigsaw Puzzle</a></li>--}}
...
{{--                                    <li><a class="dropdown-item" href="{{route('game_scratch_cat')}}">Scratcher Game</a></li>--}}
{{--                                    <div class="dropdown-divider"></div>--}}
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{route('gateway_category')}}">Withdrawal Setup</a></li>
                                    <li><a class="dropdown-item" href="{{route('activity_reward')}}">Activity Reward Setup</a></li>
                                    <div class="dropdown-divider"></div>
                    ...
                    <div class="row text-center align-items-center flex-row-reverse">
                        <div class="col-lg-auto ml-lg-auto">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item"><a href="{{route('faq')}}" target="_blank" class="link-secondary">FAQ</a></li>
                                <li class="list-inline-item"><a href="{{route('terms')}}" target="_blank" class="link-secondary">Terms &amp; Conditions</a></li>
                                <li class="list-inline-item"><a href="{{route('privacy')}}" target="_blank" class="link-secondary">Privacy Policy</a></li>
                            </ul>
                        </div>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pt-1">
                    <textarea name="a_note" class="form-control" data-toggle="autosize" placeholder="Write down your note here...">{!!$admin_share['note']!!}</textarea>
